...
namespace LibGdNet
{
    ...
    public static class LibGd
    {
        ...
        public static extern IntPtr gdImageCreateFromPngPtr(int bufSize, IntPtr buffer);

        [DllImport("libgd2.dll", EntryPoint = "gdImagePngPtr@8")]
        public static extern IntPtr gdImagePngPtr(IntPtr im, ref int size);
        ...
        public static extern IntPtr gdImageCopyResized(
               IntPtr dst, IntPtr src, int dstX, int dstY,
